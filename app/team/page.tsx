...
export default function TeamPage() {
  ...
  const teamMembers: TeamMember[] = [
    ...
    {
      id: 13,
      name: "Prof. M. R. Bachawad",
      role: "Faculty Advisor",
      team: "advisors",
      image: "/fc.jpg",
      bio: "Prof. M.R. Bachawad encourages students to explore, experiment, and engineer solutions that contribute to the future of electric mobility.",
      socialLinks: {
        email: "mailto:mrb_eep@geca.ac.in"
      }
    },
    {
      id: 14,
      ...
      team: "advisors",
      image: "/principal.jpg",
      bio: "With his vision of fostering innovation, sustainability, and leadership, he motivates students to excel in electric mobility and renewable energy research, preparing them to become responsible engineers for a progressive future.",
      socialLinks: {
        // linkedin: "https://linkedin.com/"
      },
    },
  ...
  const teamsByDepartment = useMemo(() => {
    return {
      ...
      alumini: teamMembers.filter(member => member.team === 'alumini'),
    };
  }, [teamMembers]);
    ...
    <main className="overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              >
                ...
                <h2 className="text-4xl md:text-5xl font-bold mb-6">Our Co-ordinators</h2>
                <p className="text-gray-300 text-lg mb-8">
                  Behind every successful event stands our hardworking coordinators, the true backbone of our team.</p>
                <div className="h-1 w-24 bg-gradient-to-r from-emerald-500 to-blue-500 rounded-full"></div>
              </motion.div>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 relative">
        ...
        <div id="team-advisors" ref={departmentRefs.advisors} className="mb-20">
          ...
          {/* own*/}
          <div id="team-advisors" ref={departmentRefs.advisors} className="mb-20"></div>
          <div className="text-center mb-16">
            {/* <div className="inline-block rounded-lg bg-emerald-500/10 px-4 py-2 text-sm font-medium text-emerald-400 mb-4">Advisors</div> */}
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Our Alumini</h2>
            <p className="text-gray-300 text-lg mb-8 max-w-3xl mx-auto">
             Our alumni are the pride of our institution, carrying its values and spirit wherever they go.
            </p>
            <div className="h-1 w-24 bg-gradient-to-r from-emerald-500 to-blue-500 rounded-full mx-auto"></div>
          </div>
          <div className="max-w-3xl mx-auto">
            <div className="grid grid-cols-2 gap-8 relative">
              {teamsByDepartment.alumini.map((alumini, idx) => (
                <TeamMemberCard 
                  key={alumini.id}
                  {...alumini}
                  isLarge={false}
                  onClick={() => handleOpenModal(alumini)}
                  index={idx}
                />
              ))}
